...
class _MarketplacePageState extends State<MarketplacePage> {
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (!snapshot.hasData) {
                      return Container(
                        ...
                        child: _buildMarketOverviewPlaceholder(),
                      );
                    }
                    ...
                    final activeListings = listings
                        .where((doc) =>
                            (doc.data() as Map<String, dynamic>)['isSold'] ==
                            false)
                        .length;
                    ...
                    final todaysTrades = listings.where((doc) {
                      ...
                      return createdAt != null &&
                          createdAt.toDate().isAfter(todayStart);
                    }).length;
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              _buildMarketStat(
                                  "Today's Trades", todaysTrades.toString()),
                            ],
                          ),
                        ],
                      ),
  ...
  // Placeholder for when data is loading or unavailable
  Widget _buildMarketOverviewPlaceholder() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text(
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            _buildMarketStat("Active Listings", "Loading..."),
            _buildMarketStat("Today's Trades", "Loading..."),
          ],
        ),
      ],
    );
